        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 grid-sizer"  ></div>

        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 grid-item" id="growlog-{{$day->id}}" >
            ...
            <div class="ui-block">
                <article class="hentry post">
                    ...
                    @foreach($day->images()->orderBy('created_at','desc')->take(2)->get() as $count => $image)
                            <a href="{{Cloudder::show($image->cloudinary, ["secure" => true])}}" data-fancybox="gallery{{$image->growlog_day_id}}" class="half-width @if($count==1) d-none d-md-block @endif" style="padding:0px !important">
                    ...
                    <div class="control-block-button post-control-button">
                        <a href="{{'/growlogs/'.$day->growlog_id}}" class="btn btn-control fafeed fa fa-eye">
                        </a>
